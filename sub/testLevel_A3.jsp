...
<main class="levelMain">
	<section>
		...
		<!-- 선택지 -->
		<article>
			<img src="../images/typeTest/progress_B.png">
			<h2>Q. 로션 같은 걸 발라도 30분 정도만 지나면 피부가 건조해지는 느낌이 난다</h2>
			<div>
