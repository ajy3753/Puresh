...
<main class="levelMain">
	<section>
		...
		<!-- 선택지 -->
		<article>
			<img src="../images/typeTest/progress_E.png">
			<h2>Q. 내 피부 타입은</h2>
			<div>
				<a href="testResult.jsp?type=Watermelon">
					<img src="../images/typeTest/icon-watermelon.png">건성<img src="../images/typeTest/icon-watermelon.png">
				</a>
				<a href="testResult.jsp?type=Avocado">
					<img src="../images/typeTest/icon-avocado.png">지성<img src="../images/typeTest/icon-avocado.png">
				</a>
				<a href="testResult.jsp?type=Blueberry">
					<img src="../images/typeTest/icon-blueberry.png">수분 부족형 지성<img src="../images/typeTest/icon-blueberry.png">
				</a>
				<a href="testResult.jsp?type=Mango">
					<img src="../images/typeTest/icon-mango.png">일반 복합<img src="../images/typeTest/icon-mango.png">
				</a>
			</div>
		</article>
