...
<%
	...
	// 전체 리뷰 카운트
	String reviewCount = "SELECT COUNT(*) FROM V_reivewClass";
	...
	// reviewList 불러오기
	String reviewList = "SELECT * FROM V_reivewClass";
...
<aside>
	<ul>
		...
		<li id="reviewList" class="On"><a href="pureshManager.jsp?ctg=review_reviewList">전체 리뷰 목록</a></li>
	</ul>
</aside>
