...
<main class="levelMain">
	<section>
		...
		<!-- 선택지 -->
		<article>
			<img src="../images/typeTest/progress_D.png">
			<h2>Q. 나는 평소에 피부 관리를</h2>
			<div>
				<a href="testLevel_A8.jsp">
					<img src="../images/typeTest/icon-watermelon.png">
					이것저것 많이 하고 있다
					<img src="../images/typeTest/icon-watermelon.png">
				</a>
				<a href="testLevel_A9.jsp">
					<img src="../images/typeTest/icon-blueberry.png">
					각질 제거와 수분 보충 정도만 해주고있다
					<img src="../images/typeTest/icon-blueberry.png">
				</a>
				<a href="testLevel_A10.jsp">
					<img src="../images/typeTest/icon-avocado.png">
					수분 보충만 해준다
					<img src="../images/typeTest/icon-avocado.png">
				</a>
				<a href="testLevel_A11.jsp">
